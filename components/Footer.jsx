    ...
    const linkSections = [
        ...
        },
        {
            ...
            links: [
                ...
                { text: "Gia nhập Membership", path: '/pricing', icon: null },
        ...
        },
        {
            title: "LIÊN HỆ",
            links: [
                { text: "0334451305", path: '/', icon: MailIcon },
                { text: "gocart@gmail.com", path: '/', icon: PhoneIcon },
                { text: "Hà Nội", path: '/', icon: MapPinIcon }
            ]
        }
    ];
            ...
            <div className="max-w-7xl mx-auto">
                <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-slate-500/30 text-slate-500">
                    <div>
                        ...
                        <p className="max-w-[410px] mt-6 text-sm">Chào mừng đến với gocart, điểm đến lý tưởng cho những tiện ích mới nhất và thông minh nhất. Từ điện thoại thông minh, đồng hồ thông minh đến các phụ kiện thiết yếu, chúng tôi mang đến cho bạn những cải tiến vượt trội.</p>
